// https://github.com/Araton95/erc20-airdrop-dapp/blob/master/script/app.js
...
contract Airdrop is Ownable {
   ...
   */
  function doAirdrop(IERC20 token, address[] calldata addresses, uint256 [] calldata values) onlyOwner external returns (uint256) {
    uint256 i = 0;
